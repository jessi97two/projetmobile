...
public class Favorite_restaurant extends AppCompatActivity implements
        ...
        GoogleApiClient.ConnectionCallbacks
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgBtnBackToGeneral.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent gotoGeneralPage = new Intent(Favorite_restaurant.this, GeneralActivity.class);
        ...
        listViewSearch.setOnItemClickListener(new AdapterView.OnItemClickListener(){
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(Favorite_restaurant.this, "Vous avez cliqué sur : " + selectedItem,
                        Toast.LENGTH_SHORT).show();

                Restaurant viewRestaurant = (Restaurant) correspondSeachRestaurant.get(selectedItem);
                viewRestaurant.insert(Favorite_restaurant.this);
        ...
        listViewFavoris.setOnItemClickListener(new AdapterView.OnItemClickListener(){
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(Favorite_restaurant.this, "Vous avez cliqué sur le favori : " + selectedItem,
                        Toast.LENGTH_SHORT).show();

                Restaurant favoriRestaurant = (Restaurant) correspondFavoriRestaurant.get(selectedItem);

                Intent gotoRestaurantInfoView = new Intent(Favorite_restaurant.this, RestaurantInfoViewActivity.class);
                /*Bundle b = new Bundle();
    ...
    private ResultCallback<PlaceBuffer> mUpdatePlaceDetailsCallback
        ...
        public void onResult(PlaceBuffer places) {
            ...
            CustomListviewRestaurantAdapter adapter = new CustomListviewRestaurantAdapter(Favorite_restaurant.this, restaurantName, correspondSeachRestaurant);
